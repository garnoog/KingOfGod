...
spawn(function()
   while wait(.3) do
    if Cnow == 1 then
        Cnow = 2
        Cethod = CFrame.new(-30,30,0)
        wait()
        Cethod = CFrame.new(0,30,-30)
        wait()
        Cethod = CFrame.new(30,30,0)
        wait()
        Cethod = CFrame.new(0,30,30)
...
local win = library:CreateWindow({Name = "King of god hub",Themeable = {info = "Doing by SharkDShop"}})
...
IN:AddLabel({Name = "nil%h / nil%m / nil%s"})
				...
				if not Mix_Farm then
					if game.Players.LocalPlayer.PlayerGui.Main.Quest.Visible == false then
						...
						if _G.SelectBoss ~= nil and game.Workspace.Enemies:FindFirstChild(_G.SelectBoss) or _G.SelectBoss ~= nil and game.ReplicatedStorage:FindFirstChild(_G.SelectBoss) then
							CheckQuestBoss()
							repeat wait()
							until (CFrameQBoss.Position-game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude < 9999999999999999
						...
						elseif SelectMonster ~= nil then
							CheckLevel2()
							repeat wait()
							until (CFrameQ.Position-game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude < 9999999999999999
					...
					elseif game.Players.LocalPlayer.PlayerGui.Main.Quest.Visible == true then
						if _G.Farm_Boss then
							...
							elseif game.ReplicatedStorage:FindFirstChild(Ms) then
								TP3(game.ReplicatedStorage:FindFirstChild(Ms).HumanoidRootPart.CFrame * Cethod)
								else
								    Fast_Delay = false
								    TP3(Method)
							end
...
if _G.Setting_table.FastAttack_Mode == nil then
	_G.Setting_table.FastAttack_Mode = "Smooth"
end
MIo = {
	"Super Fast",
	"Fast",
...
--[[AutoF:AddToggle({
    ...
    Callback = function()
        ame:service('VirtualInputManager'):SendKeyEvent(true, "Y", false, game)
        end
})

AutoF:AddDropdown({
    Name = "FastAttack","Fast",MIo,
    Callback = function(vu)
...
local Select_W = AutoF:AddDropdown({Name = "Select Weapon",_G.Setting_table.Weapon,Waspon,Callback = function(vu)
	_G.Setting_table.Weapon = vu
	Update_Setting(getgenv()['MyName'])
end})
AutoF:AddButton("Refresh Weapon",function(vu)
	Select_W:Clear()
	for i,v in pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do  
		if v:IsA("Tool") then
			Select_W:Add(v.Name)
							...
							for i,v in pairs(game.Workspace.Enemies:GetChildren()) do
								if v.Name == _G.Setting_table.Boss_Lock and v.Humanoid.Health > 0 then
									...
									repeat wait(_G.Fast_Delay)
									    wait()
									wait()
									TP3(v.HumanoidRootPart.CFrame*CFrame.new(0,0,30))
									wait()
									TP3(v.HumanoidRootPart.CFrame*CFrame.new(30,0,0))
									wait()
									TP3(v.HumanoidRootPart.CFrame*CFrame.new(0,0,-30))
									wait()
									TP3(v.HumanoidRootPart.CFrame*CFrame.new(-30,0,0))
									...
									TP3(v.HumanoidRootPart.CFrame*CFrame.new(0,30,0))
									wait()
									TP3(v.HumanoidRootPart.CFrame*CFrame.new(10,0,30))
									wait()
									TP3(v.HumanoidRootPart.CFrame*CFrame.new(30,0,10))
									wait()
									TP3(v.HumanoidRootPart.CFrame*CFrame.new(10,0,-30))
									wait()
									TP3(v.HumanoidRootPart.CFrame*CFrame.new(-30,0,10))
									wait()
									TP3(v.HumanoidRootPart.CFrame*CFrame.new(0,30,30))
									wait()
									TP3(v.HumanoidRootPart.CFrame*CFrame.new(0,0,30))
									wait()
									TP3(v.HumanoidRootPart.CFrame*CFrame.new(30,0,0))
						...
						for i,v in pairs(game.Workspace.Enemies:GetChildren()) do
							if v.Name == _G.Setting_table.Boss_Name and v.Humanoid.Health > 0 then
								...
								repeat wait(_G.Fast_Delay)
									...
									wait()
									TP(v.HumanoidRootPart.CFrame*CFrame.new(30,0,0))
									wait()
									TP(v.HumanoidRootPart.CFrame*CFrame.new(0,0,-30))
									wait()
									TP(v.HumanoidRootPart.CFrame*CFrame.new(-30,0,0))
									...
									wait()
									TP(v.HumanoidRootPart.CFrame*CFrame.new(10,0,30))
									wait()
									TP(v.HumanoidRootPart.CFrame*CFrame.new(30,0,10))
									wait()
									TP(v.HumanoidRootPart.CFrame*CFrame.new(10,0,-30))
									wait()
									TP(v.HumanoidRootPart.CFrame*CFrame.new(-30,0,10))
...
local FarmM = General_Tab:CreateSection("Farm Mastery")
FarmM:AddToggle({
...
CFrameBone = CFrame.new(-9514.5693359375, 164.3236541748047, 5786.55908203125)
spawn(function()
	while wait(.5) do
		pcall(function()
					...
					elseif game.ReplicatedStorage:FindFirstChild("Reborn Skeleton [Lv. 1975]") then
						...
						for i,v in pairs(game.Workspace.Enemies:GetChildren()) do
							if not string.find(v.Name,"Boss") and v.Humanoid.Health > 0 and (v.HumanoidRootPart.Position-game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 1000 then
								...
								StatrMagnet = false
								repeat wait()
								until (CFrameBone.Position-game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude < 1000
								TelePBoss(CFrameBone)
								TP(CFrameBone)
							end
						end
					end
...
General_Tab:Slider("Point",1,2450,3,function(vu)
	Points = vu
end)
...
Quest_Tab:Toggle("Auto GodHuman","9606294253",_G.Setting_table.Superhuman,function(vu)
...
General_Tab:Label("Auto Cake Prince")
local Kill_Cake_Monster_ST = General_Tab:LabelP("Kill Cake Monster : 0/500")
General_Tab:Toggle("Auto Cake Prince","9606294253",_G.Setting_table.Auto_Spikey_Trident,function(vu)
...
MC = "Cake Prince [Lv. 2300] [Raid Boss]"
spawn(function()
	while wait(.5) do
		pcall(function()
				...
				if not Mix_Farm or Auto_Spikey_Trident_Farm then
					if game.Workspace.Enemies:FindFirstChild("Cake Prince [Lv. 2300] [Raid Boss]") or game.ReplicatedStorage:FindFirstChild("Cake Prince [Lv. 2300] [Raid Boss]") then
						...
						if game.Workspace.Enemies:FindFirstChild("Cake Prince [Lv. 2300] [Raid Boss]") then
							...
							for i,v in pairs(game.Workspace.Enemies:GetChildren()) do
								if v.Name == "Cake Prince [Lv. 2300] [Raid Boss]" and v.Humanoid.Health > 0 then
									...
									repeat wait(_G.Fast_Delay)
									    game.Players.LocalPlayer.HumanoidRootPart.CFrame = CFrame.new(-2151.63916015625, 100.32628631591797, -12404.119140625)
										EquipWeapon(_G.Setting_table.Weapon)
										TP3(v.HumanoidRootPart.CFrame * Cethod)
										AttackNoCD()
						...
						elseif game.ReplicatedStorage:FindFirstChild("Cake Prince [Lv. 2300] [Raid Boss]") then
						    ...
						    if (Vector3.new("Cake Prince [Lv. 2300] [Raid Boss]")-game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 500 then
						        game.Players.LocalPlayer.HumanoidRootPart.CFrame = CFrame.new(-2151.63916015625, 100.32628631591797, -12404.119140625)
							end
						end
						...
						if (Vector3.new(-2017.4874267578125, 36.85276412963867, -12027.53515625)-game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 1200 then
							...
							for i,v in pairs(game.Workspace.Enemies:GetChildren()) do
								if not string.find(v.Name,"Boss") and v.Humanoid.Health > 0 and (v.HumanoidRootPart.Position-CFrameMon.Position).Magnitude <= 1000 then
									...
									repeat wait(_G.Fast_Delay)
										EquipWeapon(_G.Setting_table.Weapon)
										TP3(v.HumanoidRootPart.CFrame * CFrame.new(0, 30, 1))
										AttackNoCD()
									until v.Humanoid.Health <= 0 or not v.Parent or not Auto_Spikey_Trident
									StatrMagnet = false
								end
...
local Sh = Shop_Tab:CreateSection("Main")
Sh:AddToggle({
...
local Sha = Shop_Tab:CreateSection({Name = "Ability",Side = "Right"})
Sha:AddButton({
    Name = "Buy SkyJump",
    Callback = function()
    local args = {
...
elseif New_World then
    ...
    Shop_Tab:Button("Buy Microchip", function()
        local args = {
    [1] = "BlackbeardReward",
    [2] = "Microchip",
    [3] = "1"
...
game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(args))
    ...
    Island_Tab:Button("Dock", function()
        TP3(CFrame.new(-12.519311904907, 19.302536010742, 2827.853515625))
    end)

    Island_Tab:Button("Mansion", function()
        TP3(CFrame.new(-390.34829711914, 321.89730834961, 869.00506591797))
    end)

    Island_Tab:Button("Kingdom Of Rose", function()
        TP3(CFrame.new(-388.29895019531, 138.35575866699, 1132.1662597656))
    end)

    Island_Tab:Button("Cafe", function()
        TP3(CFrame.new(-379.70889282227, 73.0458984375, 304.84692382813))
    end)

    Island_Tab:Button("Sunflower Field", function()
        TP3(CFrame.new(-1576.7171630859, 198.61849975586, 13.725157737732))
    end)

    Island_Tab:Button("Jeramy Mountain", function()
        TP3(CFrame.new(1986.3519287109, 448.95678710938, 796.70239257813))
    end)

    Island_Tab:Button("Colossuem", function()
        TP3(CFrame.new(-1871.8974609375, 45.820514678955, 1359.6843261719))
    end)

    Island_Tab:Button("Factory", function()
        TP3(CFrame.new(349.53750610352, 74.446998596191, -355.62420654297))
    end)

    Island_Tab:Button("The Bridge", function()
        TP3(CFrame.new(-1860.6354980469, 88.384948730469, -1859.1593017578))
    end)

    Island_Tab:Button("Green Bit", function()
        TP3(CFrame.new(-2202.3706054688, 73.097663879395, -2819.2687988281))
    end)

    Island_Tab:Button("Graveyard", function()
        TP3(CFrame.new(-5617.5927734375, 492.22183227539, -778.3017578125))
    end)

    Island_Tab:Button("Dark Area", function()
        TP3(CFrame.new(3464.7700195313, 13.375151634216, -3368.90234375))
    end)

    Island_Tab:Button("Snow Mountain", function()
        TP3(CFrame.new(561.23834228516, 401.44781494141, -5297.14453125))
    end)

    Island_Tab:Button("Hot Island", function()
        TP3(CFrame.new(-5505.9633789063, 15.977565765381, -5366.6123046875))
    end)

    Island_Tab:Button("Cold Island", function()
        TP3(CFrame.new(-5924.716796875, 15.977565765381, -4996.427734375))
    end)

    Island_Tab:Button("Ice Castle", function()
        TP3(CFrame.new(6111.7109375, 294.41259765625, -6716.4829101563))
    end)

    Island_Tab:Button("Usopp's Island", function()
        TP3(CFrame.new(4760.4985351563, 8.3444719314575, 2849.2426757813))
    end)

    Island_Tab:Button("inscription Island", function()
        TP3(CFrame.new(-5099.01171875, 98.241539001465, 2424.4035644531))
    end)

    Island_Tab:Button("Forgotten Island", function()
        TP3(CFrame.new(-3051.9514160156, 238.87203979492, -10250.807617188))
    end)
